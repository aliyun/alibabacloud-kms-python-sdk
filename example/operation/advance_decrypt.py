...
class AdvanceDecrypt:
    ...
    async def advance_decrypt_async(
        ...
        return await client.advance_decrypt_async(request)

    @staticmethod
    def main(
        args: List[str],
    ) -> None:
        kms_instance_config = AdvanceDecrypt.create_kms_instance_config(EnvClient.get_env('your client key file path env'), EnvClient.get_env('your client key password env'), 'your kms instance endpoint', 'your ca file path')
    ...
    async def main_async(
        ...
        kms_instance_config = await AdvanceDecrypt.create_kms_instance_config_async(EnvClient.get_env('your client key file path env'), EnvClient.get_env('your client key password env'), 'your kms instance endpoint', 'your ca file path')
        client = await AdvanceDecrypt.create_client_async(kms_instance_config)
        padding_mode = 'your paddingMode'
        aad = UtilClient.to_bytes('your aad')
        ciphertext_blob = UtilClient.to_bytes('your ciphertextBlob')
        key_id = 'your keyId'
        iv = UtilClient.to_bytes('your iv')
        algorithm = 'your algorithm'
        response = await AdvanceDecrypt.advance_decrypt_async(client, padding_mode, aad, ciphertext_blob, key_id, iv, algorithm)
        print(response)
